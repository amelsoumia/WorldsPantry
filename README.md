...
- **User Profiles** - Create accounts with dietary preferences and personal information
- **Recipe Sharing** - Post and browse recipes from the community
- **Categories & Tags** - Organise and filter recipes by cuisine, meal type, dietary requirements
- **Ratings & Reviews** - Rate recipes and leave feedback for other users
- **Search Functionality** - Find recipes based on ingredients, categories, or tags
...
1. Clone the repository
   ```bash
   git clone https://github.com/amelsoumia/WorldsPantry.git
   ```
...
- Software Engineering Module Team
